	...
	spawn(function()
	    while wait(.1) do
	        if _G.FastAttackDelay then
	            pcall(function()
	                if _G.FastAttackDelay == "Pro" then
...
DiscordLib:Notification("Nhân Phẩm Đã Lên 10000%" , 10 ,11816162894 )
  end)
...
ImageButton.Size = UDim2.new(0, 26, 0, 25)
ImageButton.Image = "rbxassetid://16685735351"
